...
//CLASSEN ER "Lånt" atm. Fant bare eksterne libraries til å fikse det, men en kis hadde skrevet kode som vi kan teste.
public class DateChooser extends JTextField {
    ...
    public DateChooser(String dateFormatPattern, Date date) {
        this(date);
    ...
    private void showDateDialog(DatePanel dateChooser, Point position) {
        Frame owner = (Frame) SwingUtilities
                .getWindowAncestor(DateChooser.this);
